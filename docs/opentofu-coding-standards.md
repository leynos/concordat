...
This guide defines house rules for writing OpenTofu HashiCorp Configuration
Language (HCL) in this repository. The guidance complements the HashiCorp
Configuration Language (HCL) syntax reference and module testing guide.
...
- Pass tokens such as `github_token` via environment or continuous integration
  (CI) secrets.
